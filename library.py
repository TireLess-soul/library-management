...
#   made by  : Aryan Poonia , Gaurav , Pratik
#   session  : 2021-2022
...
# HERE STARTS A SOURCE CODE TO ADD A BOOK

def add_book():
  conn = mysql.connector.connect(host='localhost', database='ips', user='root', password="aryan2004")
  cursor = conn.cursor()
...
# HERE STARTS THE SOURCE CODE TO ADD A MEMBER
...
# HERE STARTS THE SOURCE CODE TO MODIFY A BOOK
...
# HERE THE SOURCE CODE TO MODIFY A MEMBER STARTS
...
# HERE STARTS THE SOURCE CODE TO VIEW THE MEM_ISSUE_STATUS
...
# HERE SOURCE CODE TO VIEW THE BOOK STATUS STARTS 
...
# HERE STARTS THE SOURCE CODE TO VIEW THE BOOK ISSUE STATUS
...
# HERE THE SOURCE CODE TO VIEW THE ISSUED BOOK STARTS
...
# HERE STARTS THE SOURCE CODE TO VIEW THE RETURNED BOOK
...
# HERE IS THE CODE TO SEARCH A BOOK
...
# HERE IS THE CODE OF SEARCH MENU
...
# HERE IS THE SOURCE CODE OF REPORT BOOK LIST
...
def reprot_book_list():
    ...
    conn.close()
    wait = input('\n\n\nPress any key to continue.....')
X=['Arundhati','Chetan bhagt','Ruskin bond','Kushwant singh','Vikram seth']
Y=['60','350','450','275','400']
plt.bar(X,Y)
plt.title("price of book v/s author")
plt.xlabel("AUTHOR")
plt.ylabel("PRICE OF BOOK ")
plt.show()

# HERE STARTS THE SOURCE CODE OF REPORT ISSUED BOOKS
...
# HERE THE SOURCE CODE OF REPORT AVAILALE BOOKS STARTS
...
# HERE THE SOURCE CODE OF REPORT WEED OUT BOOKS STARTS 
...
# HERE STARTS THE SOURCE CODE OF REPORT STOLEN BOOKS
...
# HERE THE SOURCE CODE OF REPORT LOST BOOKS STARTS
...
# HERE STARTS THE SOURCECODE OF REPORT MEMBER LIST STARTS
...
# HERE STARTS THE SOURCE CODE OF REPORT FINE COLLECTION 
...
# HERE STARTS THE SOURCE CODE OF REPORT MENU
...
# HERE STARTS THE SOURCE CODE TO VIEW CHANGE BOOK STATUS 
...
# HERE THE SOURCE CODE TO VIEW THE SPECIAL MENU STARTS
...
# HERE THE SOURCE CODE TO VIEW THE MAIN MENU STARTS
